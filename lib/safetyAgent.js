...
const TOXIC_INGREDIENTS_DATABASE = [
    ...
    { name: 'sodium lauryl sulfate', aliases: ['sls', 'sodium dodecyl sulfate', 'sds'], severity: 'low', reason: 'Skin and eye irritation', source: 'General concern' },
    { name: 'sodium laureth sulfate', aliases: ['sles', 'sodium lauryl ether sulfate'], severity: 'low', reason: 'May contain 1,4-dioxane impurity', source: 'General concern' },

    // Alcohols (drying)
    { name: 'denatured alcohol', aliases: ['alcohol denat', 'sd alcohol', 'ethanol'], severity: 'low', reason: 'Drying, irritating in high concentrations', source: 'General concern' },
    { name: 'isopropyl alcohol', aliases: ['isopropanol', 'rubbing alcohol', 'ipa'], severity: 'low', reason: 'Very drying, irritating', source: 'General concern' },
    ...
    // ========================
    { name: 'mineral oil', aliases: ['paraffinum liquidum', 'petrolatum', 'petroleum jelly'], severity: 'low', reason: 'May be contaminated with PAHs if not refined', source: 'EU requires purity' },
    ...
    { name: 'petrolatum', aliases: ['petroleum jelly', 'white petrolatum', 'vaseline'], severity: 'low', reason: 'Must be fully refined to remove carcinogens', source: 'EU' },
