...
4. ONLY suggest saving (action: "CONFIRM_SAVE") once you have all fields (Name, Brand, Ingredients, Price, Purchase URL, Category).
5. If some fields are still missing, use action: "ASK_INFO".
...
Return JSON:
{
  ...
  "extracted_info": { "name": "...", "brand": "...", "ingredients": "...", "description": "...", "category": "...", "price": "...", "purchase_url": "...", "image_url": "...", "suggested_images": [] },
